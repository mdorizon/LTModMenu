export const CSS = [
  ...
  "#lt-modal { background:#1e1e3a;border:3px solid #6a2a2a;border-radius:12px;padding:20px 22px;",
  '  width:320px;font-family:"HabitSmall",monospace;color:#c8c0e0;box-shadow:0 4px 20px rgba(0,0,0,0.6); }',
  "#lt-modal-title { font-size:28px;font-weight:700;color:#be6a6a;margin-bottom:10px; }",
  "#lt-modal-msg { font-size:21px;color:#8a8aaa;margin-bottom:18px;line-height:1.4; }",
  ...
  "#lt-modal-cancel { background:#1e1e3a;border-color:#3a3a6a;color:#8a8aaa; }",
